...
def get_similar_chunks_search_service(query):
    ...
    if st.session_state.category_value == "ALL":
        response = CortexSearchRetriever.search(query, COLUMNS, limit=NUM_CHUNKS)
    else: 
        filter_obj = {"@eq": {"category": st.session_state.category_value} }
        response = CortexSearchRetriever.search(query, COLUMNS, filter=filter_obj, limit=NUM_CHUNKS)
